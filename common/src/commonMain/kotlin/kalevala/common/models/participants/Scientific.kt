...
//        Fourth("Итоговый круглый стол «По земле Калевалы» (Москва)")
        First("Раздел 1 «Земля Калевалы. Туристические объекты и развитие территорий»"),
        Second("Раздел 2 «Земля Калевалы. Историко-культурный потенциал территорий»"),
        Third("Раздел 3 «Земля Калевалы. Образ Карелии в искусстве, науке и образовании»"),
//        Fourth("Итоговый круглый стол «По земле Калевалы» (Москва)")
    }
