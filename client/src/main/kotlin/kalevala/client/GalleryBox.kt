...
import kalevala.client.elements.frames.BigImage
import kalevala.client.elements.frames.BigImageProps
...
fun getGalleryType(current: String): FormType? {
    return when (current) {
        Pages.Gallery.faces.path -> FormType.Faces
        Pages.Gallery.sunCountry.path -> FormType.SunCountry
        Pages.Gallery.ethnoMotive.path -> FormType.EthnoMotive
        Pages.About.photos.path -> null
        else -> error("what??")
    }
}
